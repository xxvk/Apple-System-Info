...
public class BundleInfo{
    ...
    class var AllowMixedLocalizations: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["CFBundleAllowMixedLocalizations"] as! Bool
    ...
    class var supportsSuddenTermination: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["NSSupportsSuddenTermination"] as! Bool
    ...
    class var exitsOnSuspend: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["UIApplicationExitsOnSuspend"] as! Bool
    ...
    class var hasLocalizedDisplayName: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSHasLocalizedDisplayName"] as! Bool
    ...
    class var isAgent: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSUIElement"] as! Bool
    ...
    class var isVisibleInClassic: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSVisibleInClassic"] as! Bool
    ...
    class var isPrefersCarbon: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSPrefersCarbon"] as! Bool
    ...
    class var isPrefersClassic: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSPrefersClassic"] as! Bool
    ...
    class var isRequiresClassic: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSRequiresClassic"] as! Bool
    ...
    class var isUINewsstandApp: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["UINewsstandApp"] as! Bool
    ...
    class var isMultipleInstancesProhibited: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSMultipleInstancesProhibited"] as! Bool
    ...
    class var isRequiresIPhoneOS: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSRequiresIPhoneOS"] as! Bool
    ...
    class var isRequiresNativeExecution: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSRequiresNativeExecution"] as! Bool
    ...
    class var isGetAppDiedEvents: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["LSGetAppDiedEvents"] as! Bool
    ...
    class var FileSharingEnabled: Bool {
        get{
            ...
            let foo : Bool = self.infoDictionary["UIFileSharingEnabled"] as! Bool
...
*/
    ...
    class var categoryType: ApplicationCategory {
        get{
            let foo : String = self.infoDictionary["CFBundleVersion"] as! String
...
extension BundleInfo  {
    ...
    //  MARK: LaunchImageFile_ipad :包含了一个含有应用程序的主nib文件名（不包含.nib文件扩展名）的字符串。一个nib文件作为一个Interface Builder的存档文件，含有对用户界面的详细描述信息以及那些界面中的对象之间的关联信息。当应用程序被启动时，主nib文件会被自动装载。Mac OS X会寻找与应用程序名相匹配的nib文件。
...
/*
 ...
 辅助工具，辅助工具必须有一个嵌入式的Info.plist中包含的“SMAuthorizedClients”的字符串数组。每个字符串是一个文本表示的代码签名要求描述一个客户端，它允许添加和删除工具。
